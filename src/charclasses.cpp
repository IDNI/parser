...
template<>bool isblank<char32_t>(char32_t c) { return c < 128 && ::isblank(c); }
template<>bool iscntrl<char32_t>(char32_t c) { return c < 128 && ::iscntrl(c); }
template<>bool isdigit<char32_t>(char32_t c) { return c < 128 && ::isdigit(c); }
template<>bool isgraph<char32_t>(char32_t c) { return c < 128 && ::isgraph(c); }
template<>bool islower<char32_t>(char32_t c) { return c < 128 && ::islower(c); }
template<>bool isprint<char32_t>(char32_t c) {
	return !iseof<char32_t>(c) && (c > 160 || ::isprint(c)); }
template<>bool ispunct<char32_t>(char32_t c) { return c < 128 && ::ispunct(c); }
template<>bool isspace<char32_t>(char32_t c) { return c < 128 && ::isspace(c); }
template<>bool isupper<char32_t>(char32_t c) { return c < 128 && ::isupper(c); }
template<>bool isxdigit<char32_t>(char32_t c){ return c < 128 && ::isxdigit(c);}

}} // idni::characters namespace
