...
#ifndef __IDNI__PARSER__UTILITY__UTF8CHAR_TRAITS_H__
#define __IDNI__PARSER__UTILITY__UTF8CHAR_TRAITS_H__
...
// CharTraits for utf8char (unsigned char), used to avoid naming
// std::char_traits<unsigned char>, which libc++ deprecates.

namespace idni {

struct utf8char_traits {
...
#endif // __IDNI__PARSER__UTILITY__UTF8CHAR_TRAITS_H__
