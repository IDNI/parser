...
inline const std::vector<std::string> symbol_names{
	"", "eof", "alpha", "alnum", "space", "graph", "printable", "xdigit", "__", "_", 
	"name", "m_char", "m_space", "quoted_string", "char_lit", "unescaped_s", "escaped_s", "unescaped_c", "escaped_c", "escape_char", 
	"esc_hex", "esc_u4", "esc_U8", "start", "__E_start_0", "entry", "__E_start_1", "negate", "__E_entry_2", "__E_entry_3", 
	"words", "__E_entry_4", "matcher", "entry_tail", "item_list", "nested_block", "__E_entry_tail_5", "entry_terminator", "__E_entry_tail_6", "__E_entry_tail_7", 
	"__E_entry_tail_8", "__E_nested_block_9", "__E_nested_block_10", "item", "__E_item_list_11", "__E_item_list_12", "__E_item_13", "input", "__E_item_14", "__E_item_15", 
	"__E_item_16", "__E_item_17", "word", "__E_words_18", "__E_words_19", "__E_word_20", "w_forbid", "w_unique", "w_all", "w_any", 
	"w_raw", "m_unit", "__E_matcher_21", "__E___E_matcher_21_22", "__E_matcher_23", "__E_m_char_24", "__E_name_25", "__E_name_26", "__E_name_27", "char_lit_char", 
	"__E_unescaped_c_28", "__E_unescaped_c_29", "__E_escaped_c_30", "quoted_string_char", "__E_quoted_string_31", "__E_unescaped_s_32", "__E_unescaped_s_33", "__E_escaped_s_34", "__E_esc_hex_35", "__E___36", 
	"__E____37", "comment", "__E_comment_38", "__E_comment_39", "__E_comment_40", "__N_0", "__N_1", "__N_2", 
};

inline ::idni::nonterminals<char_type, terminal_type> nts{symbol_names};

inline std::vector<terminal_type> terminals{
	U'\0', U':', U'~', U'{', U'}', U'.', U',', U'@', U'f', 
	U'o', U'r', U'b', U'i', U'd', U'u', U'n', U'q', U'e', U'a', 
	U'l', U'y', U'w', U'\'', U'"', U'#', U' ', U'\t', U'_', U'\\', 
	U't', U'v', U'/', U'x', U'X', U'U', U'\r', U'\n', 
};
...
struct tgf_test_parser_nonterminals {
	enum nonterminal {
		nul, eof, alpha, alnum, space, graph, printable, xdigit, __, _, 
		name, m_char, m_space, quoted_string, char_lit, unescaped_s, escaped_s, unescaped_c, escaped_c, escape_char, 
		esc_hex, esc_u4, esc_U8, start, __E_start_0, entry, __E_start_1, negate, __E_entry_2, __E_entry_3, 
		words, __E_entry_4, matcher, entry_tail, item_list, nested_block, __E_entry_tail_5, entry_terminator, __E_entry_tail_6, __E_entry_tail_7, 
		__E_entry_tail_8, __E_nested_block_9, __E_nested_block_10, item, __E_item_list_11, __E_item_list_12, __E_item_13, input, __E_item_14, __E_item_15, 
