    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        no_grammar_requests = [
            ...
            ("no grammar parse", {"id": 2, "cmd": "parse",
                "input": "1"}, True),
            ("no grammar set start", {"id": 3, "cmd": "set",
                "option": "start", "value": "start"}, True),
            ("no grammar get start", {"id": 4, "cmd": "get",
                "option": "start"}, True),
            ("no grammar start", {"id": 8, "cmd": "start"}, True),
            ("no grammar load", {"id": 5, "cmd": "load",
                "file": fixture}, True),
            ("no grammar parse ok", {"id": 6, "cmd": "parse",
                "input": "12"}, True),
            ("no grammar quit", {"id": 7, "cmd": "quit"}, True),
        ]
